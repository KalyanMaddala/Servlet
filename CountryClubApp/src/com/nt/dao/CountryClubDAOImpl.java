...
public class CountryClubDAOImpl implements CountryClubDAO{
	private static final String COUNTRYCLUB_INSERT_QUERY="INSERT INTO COUNTRY_CLUB VALUES(SEQ_CLUBID.NEXTVAL,?,?,?,?,?,?)";
    public int insert(CountryClubBO bo) {
		 ...
		 try {
			 ...
			 ps.setFloat(5,bo.getDiscountAmount());
			 ps.setFloat(6,bo.getNetAmount());
			 //execute query
			 if(ps!=null)
